...
public class ContractController {
    ...
    public ResponseEntity<String> extendContract(@PathVariable Integer id, @RequestParam Integer extraYears, @RequestParam Boolean ownerApproval, @RequestParam Boolean investorApproval) {
        String result = contractService.extendContract(id, extraYears, ownerApproval, investorApproval);
